...
-- Total revenue generate by male vs female
...
select subscription_status,
	...
	round(avg(purchase_amount),2)  as total_spent,
	round(sum(purchase_amount),2) as total_revenue
	from customer
	group by subscription_status
	order by total_revenue, total_spent desc;
...
select customer_segment, count(*) as total_no_of_customers
from customer_type
